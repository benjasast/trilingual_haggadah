...
\textbf{ברך, כוס שלישית של יין}\par\vspace{0.5em}
בָּרוּךְ אַתָּה יְיָ, אֱלֹהֵינוּ מֶלֶךְ הָעוֹלָם, בּוֹרֵא פְּרִי הַגָּפֶן.\par
ושותים בהסיבה ואינו מברך ברכה אחרונה.\par\vspace{1em}
\textbf{ברך, שפוך חמתך}\par\vspace{0.5em}
...
\textbf{הלל, חצי שני של הלל}\par\vspace{0.5em}
...
\textbf{HALLEL, FOURTH CUP OF WINE}\par\vspace{0.2em}
Blessed are You, LORD our God, King of the Universe, who creates the fruit of the vine.\par
...
\textbf{HALLEL, CUARTA COPA DE VINO}\par\vspace{0.2em}
Bendito eres Tú, SEÑOR nuestro Dios, Rey del Universo, que creas el fruto de la vid.\par
